...
import 'latest_articles_model.dart';
export 'latest_articles_model.dart';

class LatestArticlesWidget extends StatefulWidget {
  const LatestArticlesWidget({super.key});
...
class _LatestArticlesWidgetState extends State<LatestArticlesWidget>
  ...
  late LatestArticlesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LatestArticlesModel());
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'anq9jl9l' /* A product designer is a creati... */,
                        ),
                        style:
