...
import 'team_rosters_model.dart';
export 'team_rosters_model.dart';

class TeamRostersWidget extends StatefulWidget {
  const TeamRostersWidget({
    super.key,
    String? playerName,
  ...
  @override
  State<TeamRostersWidget> createState() => _TeamRostersWidgetState();
}

class _TeamRostersWidgetState extends State<TeamRostersWidget>
    with TickerProviderStateMixin {
  late TeamRostersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TeamRostersModel());
